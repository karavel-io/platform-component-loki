...
To propose a change to this component, first [open an issue](https://github.com/projectkaravel/platform-component-loki/issues/new)
...
Finally [open a pull request](https://github.com/projectkaravel/platform-component-loki/compare/main) from your fork to the `main`
