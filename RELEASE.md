...
by running `git tag X.Y.0` on that branch. A [CI job](https://github.com/karavel-io/platform-component-loki/actions/workflows/release.yml) 
will kick in, packaging the component and creating the corresponding [release](https://github.com/karavel-io/platform-component-loki/releases).
